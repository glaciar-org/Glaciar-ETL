...
FILE_OUTPUT="STAGE_02_MongoDB/STEP-03/MGSET_02_2010_2015.csv"

TITULOS=${DATE_TIME}.date\(2006-01-02:15:04\),${DATE}.string\(\),${TIME}.string\(\),${AIRQ_CO}.string\(\),${AIRQ_NO}.string\(\),${AIRQ_NO2}.string\(\),${DATASET}.string\(\)

if [ ${MONGODB_MLAB_UPSALA_INSERT} == "true" ]; then
        cvs2MongoDB  ${FILE_OUTPUT}  "MGSET_02_2010_2015"  ${TITULOS} 
fi
