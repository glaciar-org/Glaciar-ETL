...
# FILE_DOWNLOAD="calidad-de-aire-2009-2019.csv"
...
FILE_DOWNLOAD="STAGE_02_MongoDB/STEP-01/calidad-de-aire-2009-2019.csv"

TITULOS="${DATE},${TIME},${AIRQ_CO},${AIRQ_NO2},${DATASET}\n"

csvCutColums  ${FILE_DOWNLOAD} ${TITULOS} "-f 2-3,4-5"   "${DATASET_OUTPUT}_CE" "${DATASET_OUTPUT}" "toMongo"  "HORAS:01-24"
csvCutColums  ${FILE_DOWNLOAD} ${TITULOS} "-f 2-3,7-8"   "${DATASET_OUTPUT}_CO" "${DATASET_OUTPUT}" "toMongo"  "HORAS:01-24"
csvCutColums  ${FILE_DOWNLOAD} ${TITULOS} "-f 2-3,10-11" "${DATASET_OUTPUT}_BO" "${DATASET_OUTPUT}" "toMongo"  "HORAS:01-24"
csvCutColums  ${FILE_DOWNLOAD} ${TITULOS} "-f 2-3,13-14" "${DATASET_OUTPUT}_PA" "${DATASET_OUTPUT}" "toMongo"  "HORAS:01-24"
...
# REGUEX PATTERN FROM
# https://unix.stackexchange.com/questions/48672/remove-comma-between-the-quotes-only-in-a-comma-delimited-file
